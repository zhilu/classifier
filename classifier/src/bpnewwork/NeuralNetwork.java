...
public class NeuralNetwork implements Serializable {
	...
	private int[] itsTopology; // Neural network topology. each element
								// inidcates neuron size on its layer.
	private Vector<DoubleMatrix> itsTheta; // Weight matrices between each
											// layer.
	...
	/*
	 * Constructs a new neural network with given topology; Initializes weight
	 * matrices with random values if initWeights == true
	 */
	...
	/**
	 * Runs forward prop to find the hypothesis (all elements of resulting
	 * matrix are between 0 and 1 inclusively)
	 */
	...
	/**
	 * Runs forward prop to find the prediction (all elements of resulting
	...
	/**
	 * Static helper methods designed to aid the process of using a neural
	 * network, and for debugging.
	 */
	...
	/**
	 * Prints the sizes of each matrix in the given List (or in this case
	 * Vector)
	 */
	...
	/**
	 * Gets a matrix from a ascii text file. The format of the text file should
	 * have each file containing only one matrix. The format of the text file
	 * should have each row separated by a newline character The format of the
	 * text file should have each column separated by a space character (' ').
	 */
	...
	/**
	 * Takes a given List of weight matrices, and extracts a neural network
	 * topology based on the sizes of the matracies.
	 */
	public static int[] extractTopologyFromWeights(Vector<DoubleMatrix> inputTheta) {
		...
		// Remember Theta is an elemnet of real numbers of dimensions
		// (S*(j+1))x(S*(j) + 1);
	...
	/**
	 * Returns the hypothesis of a neural network given weight matricies (Theta)
	 * and inputs (X) Uses forward propagation alrogrithm.
	...
	/**
	 * Given a neural network topology, generates connection matrices and
	 * initializes each element with random values
	 */
	...
	/**
	 * Takes a given input, and output, and given neural network data (weight
	 * matrices and topology), and given lambda and trains the neural network
	 * using backprop for a given amount of iterations.
	 */
